...
def args_parser():
    ...
    parser.add_argument('--aggregation', default='mean', type=str, help='Aggregation strategies, mean or weighted_mean')
    parser.add_argument('--global_prune', type=float, default=0.9, help="Global pruning ratio")
    ...
    parser.add_argument('--opt_epoch', type=int, default=50, help='number of epoch for reaching the local optimal')
    parser.add_argument('--prob', type=float, default=0.1, help='communication probability for Scafflix')
