...
if __name__ == '__main__':
    ...
    if args.method == 'fedrep' or args.method == 'fedper' or args.method == 'fedbabu' or args.method == 'FLIX' or args.method == 'Scafflix':
    ...
    for iter in range(args.epochs + 1):
        ...
        for client in participating_clients:
            # print(participating_clients, client)
            # assert 0
...
#-----------------------------------------------test--------------------------------------------------------------------
        if iter % args.test_freq==args.test_freq-1 or iter>=args.epochs-10:
            ...
            for client in clients:
                ...
                elif args.method != 'fedavg':  # also including FedAvgCS
